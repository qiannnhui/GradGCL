...
def main():
    ...
    with open('result.log', 'a+') as f:
        f.write(args.model_file+ '' +str(args.runseed) + ' ' + str(np.array(test_acc_easy_list)[np.array(val_acc_list).argmax()]) + ' ' + str(np.array(test_acc_hard_list)[np.array(val_acc_list).argmax()]))
        f.write('\n')
